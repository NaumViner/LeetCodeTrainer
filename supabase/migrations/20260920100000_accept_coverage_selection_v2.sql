-- Accept the new coverage fallback algorithm while keeping version 1 compatible during rollout.
...
begin
  ...
  if p_selection_algorithm_version is null or p_selection_algorithm_version not in (1, 2) then
