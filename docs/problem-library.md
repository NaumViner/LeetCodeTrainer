...
Company tags remain empty unless a reliable, reviewable source is provided; the schema and library filter already support them. Attempt data, adaptive recommendations, history, mastery, and review urgency now exist as private learner features. Attempt-aware manual-library filters remain a planned library enhancement; favorites remain a later enhancement.
